  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4">
      ...
      >
        ...
        <p className="text-slate-400 text-xl font-light tracking-wide max-w-2xl mx-auto mb-10">
        ...
        <div className="max-w-2xl mx-auto relative group">
          <div className="absolute inset-y-0 left-6 flex items-center pointer-events-none">
            <Search className="text-neon-cyan group-focus-within:text-neon-pink transition-colors" size={24} />
          </div>
          <input
            type="text"
            placeholder="Search manifestations by title, author, or prompt..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="w-full bg-black/50 border-2 border-white/10 rounded-full py-5 pl-16 pr-6 text-lg text-white font-light tracking-wide placeholder-slate-500 focus:outline-none focus:border-neon-cyan focus:bg-white/5 transition-all shadow-[0_0_30px_rgba(0,0,0,0.5)] group-focus-within:shadow-[0_0_50px_rgba(0,255,255,0.1)]"
          />
      ...
      <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
        {filteredManifestations.length > 0 ? (
          ...
          <div className="col-span-full py-20 text-center flex flex-col items-center justify-center text-slate-500">
            ...
            <p className="text-xl font-light tracking-wide">No manifestations found matching "{searchTerm}"</p>
          </div>
        )}
      </div>
